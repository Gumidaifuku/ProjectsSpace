  ...
  <div class="Area">
    ...
    <div class="mainArea">
      ...
      <div class="main">
        <table class="maintable" border="1">
          <tr>
            <td><img src="../img/Suzuya_Aki.png" alt="あき" width="350" height="350"></td>
            <td>公式紹介文<br>
              中学三年生。見た目が完全に女の子に見える男の子。<br>
              女の子に見える外見を自覚しており、周囲の人を騙すのが大好きで、あざとい。<br>
              性格は腹黒い。しかし、可愛いから何でも許される。</td>
          </tr>
          <tr>
            <td>Youtube(2nd)</td>
            <td><a href="https://www.youtube.com/channel/UCpnvhOIJ6BN-vPkYU9ls-Eg">鈴谷アキの陽だまりの庭</a></td>
          </tr>
          <tr>
            <td>Twitter</td>
            <td><a href="https://twitter.com/aki_suzuya">鈴谷アキ🐈にじさんじ所属</td>
          </tr>
          <tr>
            <td>ハッシュタグ</td>
            <td>ツイート：<a href="https://twitter.com/hashtag/鈴谷アキ">#鈴谷アキ</a><br>
              配信：<a href="https://twitter.com/hashtag/アキ生">#アキ生</a><br>
              ファンアート：<a href="https://twitter.com/hashtag/アキくんちゃんアート">＃アキくんちゃんアート</a><br>
            </td>
          </tr>
          <tr>
            <td>愛称</td>
          ...
          <tr>
            <td>illust</td>
            <td>ねづみどし<a href="https://twitter.com/nezumidosi_">（＠nezumidosi_）</td>
    ...
    <div class="rightArea">
      <table border="1" width="100%">
        <!-- Twitterの埋め込み -->
        <a class="twitter-timeline" data-width="300" data-height="1500" href="https://twitter.com/aki_suzuya?ref_src=twsrc%5Etfw">Tweets by aki_suzuya</a>
