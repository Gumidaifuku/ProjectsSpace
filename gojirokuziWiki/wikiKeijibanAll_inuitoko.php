...
if (isset($_POST["content"])) {
  ...
  $conn->exec($sql);
  header('Location: wikiKeijibanAll_inuitoko.php');
  exit();
}


require("sqlconnect/data_search.php");
// $sql = "SELECT * FROM inuitoko";
// $result = $conn->query($sql);
// $data_array;
// if ($result->rowCount()) {
//     foreach ($result as $r) {
//         $data_array[] = [$r[0], $r[1], $r[2],$r[3]];
//     }}
  ...
  <div class="Area">
    ...
    <div class="mainArea">
      ...
      <div class="f-container">
        ...
        <div>
          <p>個人ページへ飛ぶ--<a href="person/toko.php">戌亥とこ</a>--</p>
                ...
                <tr>
                  <td>
                    <table id="smallframe">
                      ...
                      <form action="wikiKeijibanAll_inuitoko.php" method="POST">
                        <tr>
